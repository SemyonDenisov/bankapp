...
import ru.yandex.transfer.KafkaTestConfig;
...
@SpringBootTest
@EmbeddedKafka(partitions = 1, topics = {"notification.transfer-microservice"})
@ActiveProfiles("test")
...
class NotificationServiceIntegrationTests {
    ...
    void testSendNotification() {
        ...
        ConsumerRecord<String, Object> record = KafkaTestUtils.getSingleRecord(
                consumer, "notification.transfer-microservice"
        );
